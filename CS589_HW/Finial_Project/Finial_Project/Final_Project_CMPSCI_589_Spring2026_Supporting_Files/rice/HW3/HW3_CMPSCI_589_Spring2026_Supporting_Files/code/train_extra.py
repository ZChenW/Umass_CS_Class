...
def x(k=10, max_length=10, min_samples_split=2):
    ...
    rice_csv_path = "../dataset/rice.csv"
    ...
    rice_result = cal_one_dataset(
        dataset_name=f"rice_{k}_depth_{max_length}_minsplit{min_samples_split}",
        csv_path=rice_csv_path,
        label_col=rice_csv_label_name,
        dir=f"../picture/rice_k{k}_depth{max_length}_minsplit{min_samples_split}",
        ntree_values=(1, 5, 10, 20, 30, 40, 50),
        k=k,
        random_seed=42,
    ...
    print(
        f"k = {k}, max_depth = {max_length}, min_samples_split = {min_samples_split} Rice Result:"
    )
    print(rice_result)
