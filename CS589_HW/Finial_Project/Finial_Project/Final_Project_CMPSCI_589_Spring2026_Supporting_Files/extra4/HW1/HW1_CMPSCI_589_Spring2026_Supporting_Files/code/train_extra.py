...
def cal_one_dataset(
    ...
    df = read_csv(csv_path, label_name=label_name)
    df = prepossing(df, label_name=label_name)
...
def y(k=10, kp=None):
    ...
    rice_result = cal_one_dataset(
        ...
        dir=f"../picture/rice/rice_k{k}",
        ks=kp,
        k=k,
        random_seed=42,
        label=1,
        label_name=rice_csv_label_name,
    )
...
def z(k=10, kp=None):
    ...
    park_csv_path = "../datasets/parkinsons.csv"
    park_csv_label_name = "Diagnosis"
    ...
    park_result = cal_one_dataset(
        dataset_name=f"park_{k}",
        csv_path=park_csv_path,
        label_col=park_csv_label_name,
        dir=f"../picture/parkinson/park_k{k}",
        ks=kp,
        k=k,
        random_seed=42,
        label=1,
        label_name=park_csv_label_name,
    )

    print(f"k = {k},parkinson Result:")
    print(park_result)
...
def p(k=10, kp=None):
    ...
    credit_result = cal_one_dataset(
        dataset_name=f"credit_{k}",
        csv_path=credit_csv_path,
        label_col=credit_csv_label_name,
        dir=f"../picture/redit/credit_unweighted_k{k}",
        ks=kp,
        k=k,
        random_seed=42,
        label=1,
